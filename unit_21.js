...
function t8() {
    ...
    let colorBlock = a8[Math.floor(rand * a8.length)];
    document.querySelector('.div-8').style.background = colorBlock;
...
//images.forEach(element => console.log(element.classList));
...
} else next[0].onclick = nextFunction;
...
} else prev[0].onclick = prevFunction;





function clearAllImagesActiveClass() {
    images.forEach(item => {
...
function nextFunction() {
    ...
    setImageActiveClass(count);
    setMaxImage(count + 1);


}

function setMaxImage(counter) {

    let attr = imageMax.setAttribute("src", `img/${counter}.png`);
...
document.querySelector('.out-13').innerHTML = navigator.userAgent;
...
// // console.log(img9);
// let attr = img9.getAttribute('src');
// // console.log(attr);
// if (attr == "img/1.png") {
//     img9.setAttribute("src", "img/2.png");
// }
// else {
//     img9.setAttribute("src", "img/1.png");
// }